...
public class ImagesServlet extends HttpServlet
{
	...
	private final String PERSISTENCE_UNIT_NAME = "rms2";
    
    final Logger logger = Logger.getLogger("rms-ImagesServlet");
	...
	{
		GeneralDAO gDAO = new GeneralDAO(PERSISTENCE_UNIT_NAME);
		...
		try
		{
			...
			try
			{
				...
				else
				{
					...
					{
						defaultIcon = new File(request.getRealPath("/images/photos/media1.jpg"));
						response.setHeader("Content-Type", getServletContext().getMimeType("image/jpg"));
