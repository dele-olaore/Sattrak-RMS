...
{
	private static final String PERSISTENCE_UNIT_NAME = "rms";
    ...
    final Logger logger = Logger.getLogger("rms-GeneralDAO");
    ...
    public GeneralDAO(String PERSISTENCE_UNIT_NAME)
    {
    	factory = Persistence.createEntityManagerFactory(PERSISTENCE_UNIT_NAME);
        em = factory.createEntityManager();
    }
